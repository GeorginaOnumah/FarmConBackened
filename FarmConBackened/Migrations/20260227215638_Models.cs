        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FarmName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    FarmDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FarmAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FarmLatitude = table.Column<double>(type: "float", nullable: true),
                    FarmLongitude = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransporterProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TransporterEarning = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Deliveries_TransporterProfiles_TransporterProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EscrowReference = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Rice, maize, wheat, millet etc.", null, "Grains & Cereals" },
                    { 2, "Tomatoes, peppers, onions etc.", null, "Vegetables" },
                    { 3, "Mangoes, bananas, oranges etc.", null, "Fruits" },
                    { 4, "Yam, cassava, potatoes etc.", null, "Tubers & Roots" },
                    { 5, "Beans, groundnuts, soybeans etc.", null, "Legumes" },
                    { 6, "Cattle, goats, chickens etc.", null, "Livestock & Poultry" },
                    { 7, "Milk, eggs, butter etc.", null, "Dairy & Eggs" },
                    { 8, "Ginger, garlic, turmeric etc.", null, "Herbs & Spices" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_TrackingCode",
                table: "Deliveries",
                column: "TrackingCode",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_TransporterProfileId",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_FarmerProfileId_IsAvailable",
                table: "Products",
                columns: new[] { "FarmerProfileId", "IsAvailable" });
